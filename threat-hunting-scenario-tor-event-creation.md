...
2. Install it silently: ```tor-browser-windows-x86_64-portable-15.0.13.exe```
...
## Created By:
- **Author Name**: Michael Kirby
- **Author Contact**: https://www.linkedin.com/in/wmkirby/
- **Date**: May 12, 2026
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `May 12, 2026`  | `Michael Kirby`   
